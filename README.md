...
* History list which allows use of mathematical operations on previous expressions and results, and has support for comments, bookmarks, and search
...
* Everything but the expression entry can be hidden to minimize footprint and distractions
...
#### General
   * All basic operators — arithmetic, logical, bitwise, element-wise, (in)equalities
